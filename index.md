...
> **다양한 종목과 데이터를 주기적으로 분석**<small>[^update]</small>
- 코스피 200 지수 편입 종목
- 코스닥 150 지수 편입 종목
...
---
[^update]: <small>매일 장마감 후 가능한 당일 업데이트 됩니다.</small>
[^corr]: <small>과거 유사한 방향으로 주가가 움직였던 종목을 발굴합니다. 이는 관심있는 종목과 비슷한 투자 아이디어를 적용할 수 있는 후보 종목을 발굴하기 위함입니다. 따라서 미래에도 유사한 방향으로 주가가 움직일것이라는 예상이 아닙니다.</small>
[^lev]: <small>변동성을 고려하여 레버리지 투자 또는 포트폴리오 내 비중 확대에 적합한지 파악하기 위함입니다.</small>
