주어진 정렬 조건을 제외한 다른 재무 지표도 함께 표기합니다. {span_color("붉은 색")}으로 표시된 수치는 저PER, 저PBR, 고배당에도 해당되는 경우입니다. {span_color("푸른 색", "cornflowerblue")}으로 표시된 수치는 고PER, 고PBR에 해당되는 경우입니다.
