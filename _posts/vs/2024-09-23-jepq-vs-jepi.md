...
layout: single
title: JEPQ vs JEPI
excerpt: JEPQ의 최근 2년 4개월 CAGR은 14.2%로 JEPI의 9.3%보다 4.9% 높았습니다.
header:
  overlay_color: "#333"
...
| JEPI | <span style="color: tomato">9.3<small>%</small></span> | 10.8<small>%</small> | 0.86 | -10.5<small>%</small> | -1.8<small>%</small> |
...
**수익률 지표 (CAGR):** JEPQ의 CAGR은 14.2%로 JEPI의 9.3%보다 4.9% 높았습니다. (높은 수익률)[^fn_vs_comp]

**위험도 지표 (표준편차):** JEPQ의 표준편차는 16.5%로 JEPI의 10.8%보다 5.8% 높았습니다. (높은 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 10.8% / 16.5% = 154% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
**위험도 지표 (표준편차):** 154% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 14.1%로 JEPQ의 14.2%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 160% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 14.6%로 JEPQ의 14.2%와 비슷했습니다. (비슷한 수익률)
