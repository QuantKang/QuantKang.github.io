...
- **수익률 지표 (CAGR):** KBSTAR 코스닥150선물레버리지의 CAGR은 1.6%로 KODEX 코스닥150레버리지의 -0.7%보다 2.3% 높았습니다. (높은 수익률)[fn_vs_comp]
...
- **위험도 지표 (MDD):** 100% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 -0.7%로 KBSTAR 코스닥150선물레버리지의 1.6%보다 -2.3% 낮았습니다. (낮은 수익률)
...
[KBSTAR 코스닥150선물레버리지 &gt; KODEX 코스닥150레버리지](){: .btn .btn--success}
