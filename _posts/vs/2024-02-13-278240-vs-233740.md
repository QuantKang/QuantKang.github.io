...
여기서는 KODEX 코스닥150레버리지의 투자 비중을 조절하여 동일한 위험도를 맞추어 수익률를 비교하는 방식을 사용합니다.

- **위험도 지표 1:** 표준편차를 동일한 값으로 맞추기 위해서는 57.8% / 65.5% = 113% 비중으로 투자하면 됩니다.
- **위험도 지표 2:** MDD를 동일한 값으로 맞추기 위해서는 86.0% / 85.9% = 100% 비중으로 투자하면 됩니다 
