...
excerpt: KBSTAR 코스닥150선물레버리지의 최근 6년 6개월 CAGR은 1.6%로 KODEX 코스닥150레버리지의 -0.7%낮은
header:
  overlay_color: "#333"
...
- **수익률 지표 (CAGR):** KBSTAR 코스닥150선물레버리지의 CAGR은 1.6%로 KODEX 코스닥150레버리지의 -0.7%낮은 (낮은 수익률)

- **위험도 지표 (표준편차):** KBSTAR 코스닥150선물레버리지의 표준편차는 65.5%로 KODEX 코스닥150레버리지의 57.8%낮은 (낮은 위험도)

- **위험도 지표 (MDD):** KBSTAR 코스닥150선물레버리지의 85.9%의 MDD는 KODEX 코스닥150레버리지의 86.0%비슷한 (비슷한 위험도)
