...
categories:
- vs
keywords: Microsoft Corp, MSFO, MSFO Microsoft Corp 비교, {self.base_code}{self.lev_code} {self.lev_code} 비교
---
...
**수익률 지표 (CAGR):** MSFO의 CAGR은 32.0%로 MSFT의 33.4%보다 -1.4% 낮았습니다. (낮은 수익률)[^fn_vs_comp]
