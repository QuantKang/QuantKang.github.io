...
layout: single
title: JEPQ vs JEPI
excerpt: JEPQ의 최근 2년 5개월 CAGR은 14.5%로 JEPI의 9.5%보다 5.0% 높았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** JEPQ의 CAGR은 14.5%로 JEPI의 9.5%보다 5.0% 높았습니다. (높은 수익률)[^fn_vs_comp]

**위험도 지표 (표준편차):** JEPQ의 표준편차는 16.4%로 JEPI의 10.6%보다 5.7% 높았습니다. (높은 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 10.6% / 16.4% = 154% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
**위험도 지표 (표준편차):** 154% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 14.4%로 JEPQ의 14.5%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 160% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 15.0%로 JEPQ의 14.5%와 비슷했습니다. (비슷한 수익률)
