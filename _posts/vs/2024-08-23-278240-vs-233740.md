...
| KODEX 코스닥150레버리지<sub>MDD</sub> <small>(100%)</small> | <span style="color: cornflowerblue">-1.9<small>%</small></span> | 57.2<small>%</small> | -0.03 | -86.0<small>%</small> | -54.7<small>%</small> |
...
**위험도 지표 (MDD):** 100% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 -1.9%로 RISE 코스닥150선물레버리지의 0.4%보다 -2.3% 낮았습니다. (낮은 수익률)
