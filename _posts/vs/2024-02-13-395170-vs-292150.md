...
- **위험도 지표 (표준편차):** 106% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 -8.0%로 KODEX Fn Top10동일가중의 수익률와 비슷했습니다. (비슷한 수익률)

- **위험도 지표 (MDD):** 89% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 -6.4%로 KODEX Fn Top10동일가중의 수익률보다 1.2% 높았습니다. (높은 수익률)
