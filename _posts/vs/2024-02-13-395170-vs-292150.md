...
두 상품을 비교할 수 있는 가장 긴 기간은 최근 2년 6개월입니다. 아래는 이 기간의 성과를 그래프와 표로 나타낸 것입니다 .
...
여기서는 동일한 위험도로 맞추기 위하여 TIGER TOP10의 투자 비중을 조절하여 수익률를 비교하는 방식을 사용합니다.

- **위험도 지표 1:** 표준편차를 동일한 값으로 맞추기 위해서는 20.2% / 21.5% = 1.061503537981603% 비중으로 투자하면 됩니다.
- **위험도 지표 2:** MDD를 동일한 값으로 맞추기 위해서는 37.9% / 33.7% = 0.889993196991407% 비중으로 투자하면 됩니다 
