...
두 상품의 성과를 비교할 수 있는 가장 긴 기간은 최근 1년 4개월입니다. 아래는 이 기간의 성과를 그래프와 표로 나타낸 것입니다.
...
- **수익률 지표 (CAGR):** TIGER 미국나스닥100커버드콜(합성)의 CAGR은 14.6%로 TIGER 미국나스닥100의 32.2%보다 -17.6% 낮았습니다. (낮은 수익률)
...
여기서는 TIGER 미국나스닥100의 투자 비중을 조절하여 TIGER 미국나스닥100커버드콜(합성)의 위험도와 유사하게 맞추어 수익률를 비교합니다.

- **위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 18.2% / 12.0% = 66% 비중으로 투자하면 됩니다.
- **위험도 지표 (MDD):** MDD를 동일한 값으로 맞추기 위해서는 17.2% / 12.0% = 70% 비중으로 투자하면 됩니다.

## 동일 수준 위험하에서의 성과

아래는 이렇게 비중을 조절한 경우를 포함하여 그래프와 표에 성과를 기록한 것입니다.
 TIGER 미국나스닥100<sub>STD</sub>는 표준편차를 맞춘 경우이고, TIGER 미국나스닥100<sub>MDD</sub>는 MDD를 맞춘 경우입니다.
...
- **위험도 지표 (표준편차):** 66% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 20.6%로 TIGER 미국나스닥100커버드콜(합성)의 14.6%보다 6.0% 높았습니다. (낮은 수익률)

- **위험도 지표 (MDD):** 70% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 22.0%로 TIGER 미국나스닥100커버드콜(합성)의 14.6%보다 7.3% 높았습니다. (낮은 수익률)
...
## 정리
투자 시점과 기간, 그리고 전략에 따라 다른 결과가 나올 수 있습니다. 1년 4개월간 거치식으로 투자했다고 가정하겠습니다.

TIGER 미국나스닥100의 투자 비중을 조절하여 표준편차와 MDD를 동일하게 맞추면, 평균 CAGR이 21.3%인 포트폴리오를 만둘 수 있었습니다.
TIGER 미국나스닥100커버드콜(합성)의 14.6%보다 6.7% 높았습니다.TIGER 미국나스닥100커버드콜(합성)	&gt; TIGER 미국나스닥100
