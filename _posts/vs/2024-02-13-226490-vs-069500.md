...
- **위험도 지표 (표준편차):** 95% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 7.5%로 KODEX 코스피의 수익률보다 1.2% 높았습니다. (높은 수익률)

- **위험도 지표 (MDD):** 108% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 8.4%로 KODEX 코스피의 수익률보다 2.1% 높았습니다. (높은 수익률)
