...
- **수익률 지표 (CAGR):** SOL 미국배당다우존스(H)의 CAGR은 9.3%로 SOL 미국배당다우존스의 13.8%보다 -4.5% 낮았습니다. (낮은 수익률)[fn_vs_comp]
...
- **위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 11.8% / 11.4% = 97% 비중으로 투자하면 됩니다.[fn_vs_sharpe]
...
[SOL 미국배당다우존스(H)	&lt; SOL 미국배당다우존스](){: .btn .btn--success}
