...
- **위험도 지표 (표준편차):** 97% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 13.4%로 SOL 미국배당다우존스(H)의 수익률보다 4.1% 높았습니다. (높은 수익률)

- **위험도 지표 (MDD):** 139% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 19.3%로 SOL 미국배당다우존스(H)의 수익률보다 10.0% 높았습니다. (높은 수익률)
