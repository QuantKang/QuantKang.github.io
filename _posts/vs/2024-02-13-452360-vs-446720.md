...
- **위험도 지표 (표준편차):** 97% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 13.4%로 SOL 미국배당다우존스(H)의 9.3%보다 4.1% 높았습니다. (높은 수익률)

- **위험도 지표 (MDD):** 139% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 19.3%로 SOL 미국배당다우존스(H)의 9.3%보다 10.0% 높았습니다. (높은 수익률)
...
SOL 미국배당다우존스의 투자 비중을 조절하여 표준편차와 MDD를 동일하게 맞추면, 평균 CAGR이 16.3%인 포트폴리오를 만들 수 있습니다. 이를 종합하면,
