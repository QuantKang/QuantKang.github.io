...
여기서는 동일한 위험도로 맞추기 위하여 TIGER 미국배당다우존스의 투자 비중을 조절하여 수익률를 비교하는 방식을 사용합니다.

- **위험도 지표 1:** 표준편차를 동일한 값으로 맞추기 위해서는 11.1% / 10.3% = 0.9299636145536514% 비중으로 투자하면 됩니다.
- **위험도 지표 2:** MDD를 동일한 값으로 맞추기 위해서는 7.7% / 7.9% = 1.0346382770779048% 비중으로 투자하면 됩니다 
