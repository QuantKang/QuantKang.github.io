...
- **위험도 지표 (표준편차):** 83% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 11.2%로 XYLD의 5.3%보다 5.9% 높았습니다. (높은 수익률)

- **위험도 지표 (MDD):** 103% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 13.8%로 XYLD의 5.3%보다 8.4% 높았습니다. (높은 수익률)
