...
excerpt: PYPY의 최근 9개월 CAGR은 6.2%로 PayPal Holdings Inc(PYPL)의 -3.5%보다 9.7% 높았습니다.
header:
  overlay_color: "#333"
...
categories:
- vs
keywords: PayPal Holdings Inc, PYPY, PYPY PayPal Holdings Inc 비교, {self.base_code}{self.lev_code} {self.lev_code} 비교
---
...
**수익률 지표 (CAGR):** PYPY의 CAGR은 6.2%로 PYPL의 -3.5%보다 9.7% 높았습니다. (높은 수익률)[^fn_vs_comp]
