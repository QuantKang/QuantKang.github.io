...
layout: single
title: ISPY vs GPIX
excerpt: ISPY의 최근 6개월 CAGR은 30.4%로 GPIX의 28.2%보다 2.3% 높았습니다.
header:
  overlay_color: "#333"
...
**수익률 지표 (CAGR):** ISPY의 CAGR은 30.4%로 GPIX의 28.2%보다 2.3% 높았습니다. (높은 수익률)[^fn_vs_comp]

**위험도 지표 (표준편차):** ISPY의 표준편차는 9.6%로 GPIX의 9.1%와 비슷했습니다. (비슷한 위험도)
...
**위험도 지표 (표준편차):** 표준편차를 동일한 값으로 맞추기 위해서는 9.1% / 9.6% = 106% 비중으로 투자하면 됩니다.[^fn_vs_sharpe]
...
**위험도 지표 (표준편차):** 106% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 30.2%로 ISPY의 30.4%와 비슷했습니다. (비슷한 수익률)

**위험도 지표 (MDD):** 99% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 27.8%로 ISPY의 30.4%보다 -2.7% 낮았습니다. (낮은 수익률)
...
이 포트폴리오는 ISPY의 30.4%보다 -1.5% 낮았습니다.
