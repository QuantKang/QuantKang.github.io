...
- **수익률 지표 (CAGR):** VT의 CAGR은 7.2%로 VTI의 11.0%보다 -3.9% 낮았습니다. (낮은 수익률)
...
여기서는 VTI의 투자 비중을 조절하여 VT의 위험도와 유사하게 맞추어 수익률를 비교합니다.
...
아래는 이렇게 비중을 조절한 경우를 포함하여 그래프와 표에 성과를 기록한 것입니다.
 VTI<sub>STD</sub>는 표준편차를 맞춘 경우이고, VTI<sub>MDD</sub>는 MDD를 맞춘 경우입니다.
...
- **위험도 지표 (표준편차):** 104% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 11.3%로 VT의 7.2%보다 4.2% 높았습니다. (낮은 수익률)

- **위험도 지표 (MDD):** 105% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 11.4%로 VT의 7.2%보다 4.3% 높았습니다. (낮은 수익률)
...
## 정리
투자 시점과 기간, 그리고 전략에 따라 다른 결과가 나올 수 있습니다. 15년 7개월간 거치식으로 투자했다고 가정하겠습니다.

VTI의 투자 비중을 조절하여 표준편차와 MDD를 동일하게 맞추면, 평균 CAGR이 11.4%인 포트폴리오를 만둘 수 있었습니다.
VT의 7.2%보다 4.2% 높았습니다.VT	&gt; VTI
