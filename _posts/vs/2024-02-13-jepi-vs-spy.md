...
- **위험도 지표 (표준편차):** 62% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 10.3%로 JEPI의 수익률보다 -1.5% 낮았습니다. (낮은 수익률)

- **위험도 지표 (MDD):** 56% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 9.4%로 JEPI의 수익률보다 -2.4% 낮았습니다. (낮은 수익률)
