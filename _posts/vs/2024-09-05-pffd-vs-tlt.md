...
**위험도 지표 (표준편차):** 85% 투자 비중으로 표준편차를 비슷한 수준으로 맞추면, CAGR은 -0.7%로 PFFD의 2.7%보다 -3.3% 낮았습니다. (낮은 수익률)

**위험도 지표 (MDD):** 64% 투자 비중으로 하여 MDD를 비슷한 수준으로 맞추면, CAGR은 -0.3%로 PFFD의 2.7%보다 -3.0% 낮았습니다. (낮은 수익률)
